        ...
        <div className="auth-card w-full max-w-md rounded-[26px] bg-white px-5 py-6 shadow-[0_18px_50px_rgba(15,23,42,0.10)] sm:px-6 sm:py-7">
          ...
          <form onSubmit={handleSignup} className="grid gap-3">
            ...
            <button
              ...
              className="mt-1 inline-flex h-11 items-center justify-center gap-2 rounded-full bg-[#02081f] px-5 text-sm font-semibold text-white transition duration-300 hover:-translate-y-0.5 hover:bg-[#0a1438] hover:shadow-[0_16px_40px_rgba(2,8,31,0.22)] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isSubmitting ? (
