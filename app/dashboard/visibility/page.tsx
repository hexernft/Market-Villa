  ...
  if (businesses.length === 0) {
    return (
      <section className="mx-auto max-w-3xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        <div className="mx-auto grid h-10 w-12 place-items-center bg-[#7c3aed] text-white">
          <Sparkles size={20} />
        </div>
        ...
        <Link
          ...
          className="mt-7 inline-flex items-center justify-center gap-2 rounded-full bg-[#7c3aed] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#8b5cf6]"
        >
          Start setup
          <ArrowRight size={16} />
        </Link>
      ...
      <section className="border border-slate-200 bg-white p-5 shadow-sm">
        <div className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <select
            ...
            className="h-11 min-w-72 border border-slate-200 bg-white px-4 text-sm font-medium text-slate-700 outline-none focus:border-[#7c3aed]"
          >
        ...
        {statCards.map((card) => {
          ...
          return (
            ...
            >
              ...
              <p className="mt-8 text-2xl font-semibold tracking-[-0.05em] text-slate-950">
                {card.value}
              </p>
            </div>
          );
      ...
      <section className="grid gap-5 xl:grid-cols-[1fr_0.85fr]">
          ...
          <div className="grid gap-3">
            ...
            <div className="flex items-center justify-between border border-slate-200 bg-slate-50 p-4">
              <div className="flex items-center gap-3">
                <Star
                  size={18}
                  className={featuredActive ? "text-[#7c3aed]" : "text-slate-400"}
                />
                <span className="text-sm font-semibold text-slate-700">
                  Featured placement
                </span>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            {selectedBusiness?.slug ? (
              <Link
                ...
                target="_blank"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[#7c3aed] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#8b5cf6]"
              >
                View store
                <ArrowRight size={16} />
              </Link>
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 hover:border-[#7c3aed]/40 hover:text-[#7c3aed]"
            >
              <Copy size={16} />
              Copy link
            </button>
        ...
        <aside className="border border-slate-200 bg-[#26143d] p-5 text-white shadow-sm">
                ...
                <button
                  ...
                  className={`text-left transition ${
                    isSelected
                      ...
                      : "border-white/10 bg-white/5 hover:border-[#7c3aed]/50 hover:bg-white/10"
                  } border p-4`}
                >
          ...
          <button
            ...
            className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-slate-950 hover:bg-purple-50 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {isRequestingFeature ? (
                ...
                <div className="grid gap-3 text-xs text-slate-400 md:text-right">
                  ...
                  {purchase.request_type && purchase.request_type !== "verified_badge" ? (
                    <button
                      ...
                      className="inline-flex items-center justify-center rounded-full bg-[#7c3aed] px-4 py-2 text-xs font-semibold text-white transition hover:bg-[#8b5cf6]"
                    >
                      Renew package
                    </button>
                  ) : null}
