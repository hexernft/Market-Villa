        ...
        <div className="grid gap-4 xl:grid-cols-[1fr_auto] xl:items-center">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="rounded-2xl bg-purple-50 px-3 py-2.5">
              <p className="text-xs text-purple-700">URL</p>
      ...
      <section className="grid gap-5 xl:grid-cols-[1fr_0.7fr]">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <label className="grid gap-2">
                ...
                <input
                  ...
                  className="rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none transition focus:border-[#8b4dff] focus:ring-4 focus:ring-slate-100"
        ...
        <aside className="grid content-start gap-4">
          ...
          <div className="rounded-[1.5rem] border border-purple-200 bg-purple-50 p-4">
            <p className="font-semibold text-white">Store link</p>

            <p className="mt-2 break-all text-sm leading-6 text-purple-100">
              /store/{slug || selectedBusiness?.slug}
            </p>
